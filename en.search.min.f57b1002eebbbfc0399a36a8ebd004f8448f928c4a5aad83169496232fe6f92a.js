...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/mockk-guidebook/flexsearch.min.js');loadScript('/mockk-guidebook/en.search-data.min.c616ae9dc6edd7f514e1966341a5d1027185969a4e6ef81a4284eeb40c0cce7e.js',function(){input.required=false;search();});}

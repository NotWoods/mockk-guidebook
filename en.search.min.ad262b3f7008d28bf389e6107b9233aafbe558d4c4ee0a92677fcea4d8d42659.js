...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/mockk-guidebook/flexsearch.min.js');loadScript('/mockk-guidebook/en.search-data.min.49ccdcdd92d3ef0ed29f4df249406e4daeb99d573230c9d4035fb224586cfdd5.js',function(){input.required=false;search();});}

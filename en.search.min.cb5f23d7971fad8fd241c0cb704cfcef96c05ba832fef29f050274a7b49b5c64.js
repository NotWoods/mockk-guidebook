...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/mockk-guidebook/flexsearch.min.js');loadScript('/mockk-guidebook/en.search-data.min.18d46d3a8a34f13d828a1ef3aeabfaead8e46e93244313c9a600e258ee54c551.js',function(){input.required=false;search();});}

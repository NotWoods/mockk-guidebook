...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/mockk-guidebook/flexsearch.min.js');loadScript('/mockk-guidebook/en.search-data.min.1f6eb2bbde685a574cfd27512018f801180643f069ae75a01c737a0e3b813a75.js',function(){input.required=false;search();});}

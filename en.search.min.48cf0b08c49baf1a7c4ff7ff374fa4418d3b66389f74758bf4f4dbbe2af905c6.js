...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/mockk-guidebook/flexsearch.min.js');loadScript('/mockk-guidebook/en.search-data.min.7c6496294255be974704297882547f3b0ca8fe08349fd1c171e8fca70fead84f.js',function(){input.required=false;search();});}
